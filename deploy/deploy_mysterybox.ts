...
const func: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  ...
  const deployWhitelistQlf = true;
  const deploySigVerifyQlf = true;
  const deployMaskHolderQlf = true;
  const deployMerkleProofQlf = true;

  const upgradeMysteryBox = true;
  const upgradeMaskEnumerableNFT = true;
  const upgradeWhitelistQlf = true;
